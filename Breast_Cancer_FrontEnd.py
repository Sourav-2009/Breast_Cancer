...
# Introduction
st.markdown("""<p style="color:#f2f3f4;font-weight:bolder;background-color:rgba(255,255,0,0.5);padding:50px">Breast cancer is a significant health concern impacting women worldwide. This model provides a comprehensive overview on the emerging role of machine learning in breast cancer detection.</p>""",unsafe_allow_html=True)
